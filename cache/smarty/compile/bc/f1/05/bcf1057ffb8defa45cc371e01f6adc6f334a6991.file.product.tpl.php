<?php /* Smarty version Smarty-3.1.19, created on 2016-10-14 10:59:52
         compiled from "/Applications/MAMP/websites/consorcioHospitalario/themes/wt_elmart/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:659477382580100f86265d1-27020766%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bcf1057ffb8defa45cc371e01f6adc6f334a6991' => 
    array (
      0 => '/Applications/MAMP/websites/consorcioHospitalario/themes/wt_elmart/product.tpl',
      1 => 1476139775,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '659477382580100f86265d1-27020766',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_580100fa0ff204_18565712',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580100fa0ff204_18565712')) {function content_580100fa0ff204_18565712($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Applications/MAMP/websites/consorcioHospitalario/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/Applications/MAMP/websites/consorcioHospitalario/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/Applications/MAMP/websites/consorcioHospitalario/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/Applications/MAMP/websites/consorcioHospitalario/tools/smarty/plugins/function.counter.php';
?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
												...
												<?php } elseif (($_smarty_tpl->tpl_vars['group']->value['group_type']=='color')) {?>
														<ul id="<?php echo htmlspecialchars(mb_strtolower($_smarty_tpl->tpl_vars['group']->value['group_name'], 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
_to_pick_list" class="<?php if (mb_strtolower($_smarty_tpl->tpl_vars['group']->value['group_name'], 'UTF-8')!='color') {?>wt-group-attribute <?php }?>wt-group-<?php echo htmlspecialchars(mb_strtolower($_smarty_tpl->tpl_vars['group']->value['group_name'], 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
 clearfix">
...
?>
															...
															<li class="color-<?php echo htmlspecialchars(mb_strtolower($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['name'], 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
<?php if ($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value) {?> selected<?php }?>">
																<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['product']->value), ENT_QUOTES, 'UTF-8', true);?>
...
" width="20" height="20" />
																	<?php } else { ?>
																		<?php if (mb_strtolower($_smarty_tpl->tpl_vars['group']->value['group_name'], 'UTF-8')!='color') {?>
																			<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['name'], ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>
		...
		<!-- end center infos-->
			...
			<div class="pb-right-column col-xs-12 col-sm-6 col-md-3">
				<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayProductRight"),$_smarty_tpl);?>
...
">
										...
										<div class="clearfix" style="margin-top:5px">
											<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&$_smarty_tpl->tpl_vars['add_prod_display']->value==1) {?>
												<div class="no-print">
													<a class="exclusive button ajax_add_to_cart_button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,'qty=1&amp;id_product={$accessory.id_product|intval}&amp;token={$static_token}&amp;add'), ENT_QUOTES, 'UTF-8', true);?>
