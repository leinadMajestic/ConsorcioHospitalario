<?php /* Smarty version Smarty-3.1.19, created on 2016-10-14 10:27:19
         compiled from "/Applications/MAMP/websites/consorcioHospitalario/themes/wt_elmart/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2626908855800f9572806b1-02358734%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ef10c5d4d3b92d9c7334365064b8ba1f52f978a' => 
    array (
      0 => '/Applications/MAMP/websites/consorcioHospitalario/themes/wt_elmart/modules/blockcart/blockcart.tpl',
      1 => 1476139775,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2626908855800f9572806b1-02358734',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5800f9587ae255_11337411',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5800f9587ae255_11337411')) {function content_5800f9587ae255_11337411($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/Applications/MAMP/websites/consorcioHospitalario/tools/smarty/plugins/modifier.replace.php';
...
<div class="out-shopping_cart <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
...
" rel="nofollow">
			...
			<span class="ajax_cart_product_txt">: <?php echo $_smarty_tpl->tpl_vars['total']->value;?>
</span>
...
" rel="nofollow">
						...
						<div class="cart-prices">
							<div class="cart-prices-line first-line">
							   <span class="labels_cart cart_block_shipping_label<?php if (!($_smarty_tpl->tpl_vars['page_name']->value=='order-opc')&&$_smarty_tpl->tpl_vars['shipping_cost_float']->value==0&&(!isset($_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)||!$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)) {?> unvisible<?php }?>">
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
							...
							<?php if ($_smarty_tpl->tpl_vars['show_tax']->value&&isset($_smarty_tpl->tpl_vars['tax_cost']->value)) {?>
								<div class="cart-prices-line">
								<span class="labels_cart"><?php echo smartyTranslate(array('s'=>'Tax','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
							...
							<div class="cart-prices-line out_cart_block_total last-line">
							    <span class="labels_cart"><?php echo smartyTranslate(array('s'=>'Total','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
...
<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&$_smarty_tpl->tpl_vars['active_overlay']->value==1) {?>
	<div id="layer_cart">
		<div class="clearfix">
			<div class="layer_cart_product col-xs-12 col-lg-6">
...
"></span>
			...
			<div class="layer_cart_cart col-xs-12 col-lg-6">
			  <h2>
					<!-- Plural Case [both cases are needed because page may be updated in Javascript] -->
					<span class="ajax_cart_product_txt_qv_s <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<2) {?> unvisible<?php }?>">
					...
					<span class="ajax_cart_product_qv_txt <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>1) {?> unvisible<?php }?>">
...
">
						<span>
							<i class="icon-chevron-left left"></i><?php echo smartyTranslate(array('s'=>'Continue','mod'=>'blockcart'),$_smarty_tpl);?>
