...
<div id="wt_category_feature" class="wt_category_feature clearfix">
	<h1 class="home-title">{l s='New' mod='wtcategoryfeature'}</h1>
	<h3>{l s='Categories' mod='wtcategoryfeature'}</h3>
	{if isset($wt_categories) && $wt_categories|@count > 0}
		<div class="list_carousel responsive clearfix">
			...
			{assign var=category value=$item_category.category}
				 <div class="item col-sm-2 {if $smarty.foreach.item_category.first|intval}first_item{elseif $smarty.foreach.item_category.last|intval}last_item{/if}">
					<div class="content">
