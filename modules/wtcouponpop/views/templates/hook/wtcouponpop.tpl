...
{/if}
    ...
    <div class="inner">
		<div class="clearfix newsletter-content">
			{$newsletter_setting.content|escape:'quotes':'UTF-8'}
		</div>
		<div class="newsletter-form">
			<div class="g-newsletter-form">
				<input class="input-email" id="input-email" type="text" name="email" size="18" placeholder="{l s='Enter your email...' mod='wtcouponpop'}" value="" />                    
			...
			<div class="wt-popup-close"><a href="javascript:void(0)" onclick="closeDialog(cookies_time)">
				<img src="{$wt_coupon_url|escape:'html':'UTF-8'}/views/img/icon-close.png" alt="icon close"/> </a>
			</div>
			{if $voucher_code != ''}
...
{addJsDefL name=regisNewsletterMessage}{l s='You have just subscribled successfully!' js=1 mod='wtcouponpop'}{/addJsDefL}
{addJsDefL name=enterEmail}{l s='Enter your email please!' js=1  mod='wtcouponpop'}{/addJsDefL}
{/if}
