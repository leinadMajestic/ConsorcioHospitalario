...
class WtBlogLatestNews extends Module
{
	...
	{
		if (!parent::install()
		|| !$this->registerHook('displayBlogFooter')
		...
		|| !$this->registerHook('actionsbtogglepost'))
			return false;
		Configuration::updateGlobalValue('wtshowhomepost', 3);
		return true;
	}
	...
	public function hookDisplayBlogFooter()
	{
		...
		else
		{
			...
			{
				$view_data['posts'] = WTBlog::getLastestPost($id_lang, $id_shop, Configuration::get('wtshowhomepost'), $img = '_medium.jpg');
				$this->smarty->assign(array(
