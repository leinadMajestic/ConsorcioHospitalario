...
<div id="search_block_left" class="block exclusive">
	<h4 class="title_block">{l s='Search' mod='wtblocksearch'}</h4>
	<form method="get" action="{$link->getPageLink('search', true)|escape:'html':'UTF-8'}" id="searchbox">
		<p class="block_content">
			<label for="search_query_block">{l s='Search products:' mod='wtblocksearch'}</label>
			...
			<input type="submit" id="search_button" class="button_mini" value="{l s='Go' mod='wtblocksearch'}" />
		</p>
	</form>
</div>
