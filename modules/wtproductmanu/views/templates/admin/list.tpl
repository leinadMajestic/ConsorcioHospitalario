...
*}
{if count($banners) > 0}
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Banner List' mod='wtproductmanu'}
			...
			{foreach from=$banners item=banner}
				<div id="slides_{$banner.id_wtproductmanu|intval}" class="panel">
					<div class="row">
						...
						<div class="col-md-2">
							<h4 class="pull-left">{l s='Link' mod='wtproductmanu'}: {$banner.link|escape:'html':'UTF-8'}</h4>
						</div>
						<div class="col-md-2">
							<h4 class="pull-left">{l s='Position' mod='wtproductmanu'}: {$banner.position|escape:'html':'UTF-8'}</h4>
						</div>
						<div class="col-md-4">	
