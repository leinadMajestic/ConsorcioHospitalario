...
class WtProductManu extends Module
{
	...
	public function __construct()
	{
		...
		$this->bootstrap = true;
		parent::__construct();
		$this->displayName = $this->l('WT Products Manufacture');
	...
	{
		$this->context = Context::getContext();
		$manu_f = Manufacturer::getManufacturers(8, 0, true, 1, 8);
		$new_prod_manu = array();
		foreach ($manu_f as $manu_f_item)
		{
			$id_manu = $manu_f_item['id_manufacturer'];
			$prod_manu = Manufacturer::getProducts($id_manu, 1, 0, 8);
		...
		if (!empty($manu_f))
		{
			...
			return $this->display(__FILE__, 'wtproductmanu.tpl');
		}
	}
