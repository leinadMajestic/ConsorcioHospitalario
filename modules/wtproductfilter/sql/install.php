...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wtproductfilter` (
    `id_wtproductfilter` int(11) NOT NULL AUTO_INCREMENT,
    ...
    PRIMARY KEY  (`id_wtproductfilter`)
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';

$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wtproductfilter_shop` (
    `id_wtproductfilter` int(11) NOT NULL AUTO_INCREMENT,
	`shownew` int(10) unsigned NOT NULL,
	`showfeature` int(10) unsigned NOT NULL,
	`showsale` int(10) unsigned NOT NULL,
	...
	`use_slider` int(10) unsigned NOT NULL,
	`active` tinyint(1) unsigned NOT NULL DEFAULT \'0\',
    PRIMARY KEY  (`id_wtproductfilter`, `id_shop`)
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';
