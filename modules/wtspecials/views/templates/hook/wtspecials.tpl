...
*}
{$number_line = 1}
<div id="wt-special-products" class="wt-special-products col-xs-12 col-sm-12 col-md-3">
	<div class="block-title deal-title">
		<h3>{l s='Hot Deal' mod='wtspecials'}</h3>
	</div>
	<div class="container">
					...
					{if isset($wtconfig->used_slider) && $wtconfig->used_slider == 1}
						<script type="text/javascript">
							$(document).ready(function() {
								$("#index #wt-special-products .special-prod-slider").owlCarousel({
									loop: true,
									slideSpeed: 100,
									responsive: {
										0: { items: 1},
