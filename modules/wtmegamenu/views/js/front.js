...
function addMoreResponsive(nIpadHorizontal,nIpadVertical,htmlLiH,htmlLiV,htmlMenu) 
{
	if(nIpadHorizontal>0 && nIpadVertical>0)
	{
		...
		{	
			if($("#more_menu").length==0)
			{
				$('<li id="more_menu" class="level-1 more-menu"><a href="#"><span>' + text_more + '</span></a><ul class="menu-dropdown cat-drop-menu wt-sub-auto">' + htmlLiV + '</ul></li>').insertAfter('#wt-menu-horizontal ul.menu-content li.level-1:nth-child('+nIpadVertical+')');
			}
			if($("#more_menu").length>0)
		...
		else if($(window).width() > 992 && $(window).width() <= 1199)
		{
			...
			if($("#more_menu").length==0)
				$('<li id="more_menu" class="level-1 more-menu"><a href="#"><span>' + text_more + '</span></a><ul class="menu-dropdown cat-drop-menu wt-sub-auto">' + htmlLiH + '</ul></li>').insertAfter('#wt-menu-horizontal ul.menu-content li.level-1:nth-child('+nIpadHorizontal+')');
			if($("#more_menu").length>0)
