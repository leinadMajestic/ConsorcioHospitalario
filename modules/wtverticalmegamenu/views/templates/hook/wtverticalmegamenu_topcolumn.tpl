...
<!-- Module Megamenu-->
<div id="wt-menu-ver-left" class="wt-menu-ver-left col-sm-3 col-md-3">
{$id_lang = Context::getContext()->language->id}
	<div class="category-left">
	<div class="title-menu-mobile category-title"><span>{l s='Categories' mod='wtverticalmegamenu'}</span></div>
