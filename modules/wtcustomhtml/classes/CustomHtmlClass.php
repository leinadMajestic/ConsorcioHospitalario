...
class CustomHtmlClass extends ObjectModel
{
	public $id_wtcustomhtml;
	public $title;
	public $content;
	public $active;
	public $hook;
	...
	public	function __construct($id_tab = null, $id_lang = null, $id_shop = null, Context $context = null)
	{
		...
		Shop::addTableAssociation('wtcustomhtml', array('type' => 'shop'));
		Shop::addTableAssociation('wtcustomhtml_lang', array('type' => 'fk_shop'));
		if ($this->id)
		{
	...
	public function getFieldShop($field)
	{
		...
		$sql = 'SELECT bs.'.$field.' FROM '._DB_PREFIX_.'wtcustomhtml b
		LEFT JOIN '._DB_PREFIX_.'wtcustomhtml_shop bs ON (b.id_wtcustomhtml = bs.id_wtcustomhtml)
		WHERE b.id_wtcustomhtml = '.$this->id.' AND bs.id_shop = '.$id_shop.'';
