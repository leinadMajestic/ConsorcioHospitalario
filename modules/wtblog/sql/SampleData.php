...
class SampleDataBlog
{
	public function installConfiguration($id_shop = null)
	{
		...
		Configuration::updateValue('WT_IMG_SMALL_SIZE', 230);
		Configuration::updateValue('WT_IMG_SMALL_H_SIZE', 150);
		Configuration::updateValue('WT_IMG_MEDIUM_SIZE', 430);
		Configuration::updateValue('WT_IMG_MEDIUM_H_SIZE', 280);
		Configuration::updateValue('WT_IMG_LARGE_SIZE', 600);
		Configuration::updateValue('WT_IMG_LARGE_H_SIZE', 390);
		Configuration::updateValue('WT_IMG_CATEGORY_SIZE', 880);
		Configuration::updateValue('WT_IMG_CATEGORY_H_SIZE', 260);
