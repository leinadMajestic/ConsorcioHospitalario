					...
					<div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
						...
						<div class="cart-prices">
							<div class="cart-prices-line first-line">
							   <span class="labels_cart cart_block_shipping_label{if !($page_name == 'order-opc') && $shipping_cost_float == 0 && (!isset($cart->id_address_delivery) || !$cart->id_address_delivery)} unvisible{/if}">
		...
		<div class="clearfix">
			...
			<div class="layer_cart_cart col-xs-12 col-lg-6">
			  <h2>
					...
					<span class="ajax_cart_product_txt_qv_s {if $cart_qties < 2} unvisible{/if}">
					...
					<span class="ajax_cart_product_qv_txt {if $cart_qties > 1} unvisible{/if}">
