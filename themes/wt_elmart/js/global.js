...
function display(view)
{
	if (view == 'list')
	{
		...
		$('.product_list > li').removeClass('col-lg-4');
		...
		$('.product_list > li').each(function(index, element) {
			...
			html = '<div class="product-container"><div class="row">';
				html += '<div class="left-block col-xs-12 col-sm-4"><div class="product-image-container">' + $(element).find('.product-image-container').html() + '</div></div>';
	...
	else
	{
		...
		html += '<div class="product-container">';
			var img_prod = $(element).find('.left-block').html();
			if (img_prod != null)
