...
<div id="newsletter_block_left" class="block col-xs-12 col-sm-12">
    ...
    <img src="{$content_dir|escape:'html':'UTF-8'}themes/wt_elmart/img/newletter.jpg" alt=""/>
	</div>
	<div class="wt-out-letter col-xs-12 col-sm-6">
	<h4>{l s='Subcrible To Our Newsletter' mod='blocknewsletter'}</h4>
	<div class="block_content">
		<form action="{$link->getPageLink('index', null, null, null, false, null, true)|escape:'html':'UTF-8'}" method="post">
			<div class="form-group{if isset($msg) && $msg } {if $nw_error}form-error{else}form-ok{/if}{/if}" >
			
				<label>{l s='Email' mod='blocknewsletter'}</label>
